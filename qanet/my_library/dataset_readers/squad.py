"""
Code directly taken from https://github.com/allenai/allennlp/blob/master/allennlp/data/dataset_readers/reading_comprehension/squad.py
Minor changes made to include `id` in the metadata
"""
...
@DatasetReader.register("squad_custom")
    ...
    def text_to_instance(
        ...
        for char_span_start, char_span_end in char_spans:
            ...
            if error:
                ...
                logger.debug(
                    "Tokens in answer: %s", passage_tokens[span_start : span_end + 1]
                )
