...
parser.add_argument(
    "dataset", type=str, default=None, help="SQuAD-like dataset to evaluate on"
)
parser.add_argument("--model", type=str, default=None, help="Path to model to use")
parser.add_argument(
    "--embedding-file",
    type=str,
    default=None,
...
parser.add_argument(
    ...
    type=str,
    default="/tmp",
    help=("Directory to write prediction file to " "(<dataset>-<model>.preds)"),
)
parser.add_argument(
    "--tokenizer",
    type=str,
...
parser.add_argument("--batch-size", type=int, default=128, help="Example batching size")
parser.add_argument(
    "--top-n", type=int, default=1, help="Store top N predicted spans per example"
)
parser.add_argument(
    "--official",
    action="store_true",
