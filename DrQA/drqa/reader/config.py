...
def add_model_args(parser):
    ...
    model.add_argument(
        "--model-type", type=str, default="rnn", help="Model architecture type"
    )
    model.add_argument(
        "--embedding-dim",
        type=int,
    ...
    model.add_argument(
        "--hidden-size", type=int, default=128, help="Hidden size of RNN units"
    )
    model.add_argument(
        "--doc-layers",
        type=int,
    ...
    model.add_argument(
        "--rnn-type", type=str, default="lstm", help="RNN type: LSTM, GRU, or RNN"
    )
    ...
    detail.add_argument(
        "--use-pos", type="bool", default=True, help="Whether to use pos features"
    )
    detail.add_argument(
        "--use-ner", type="bool", default=True, help="Whether to use ner features"
    )
    detail.add_argument(
        "--use-lemma", type="bool", default=True, help="Whether to use lemma features"
    )
    detail.add_argument(
        "--use-tf",
        type="bool",
    ...
    optim.add_argument(
        "--dropout-rnn", type=float, default=0.4, help="Dropout rate for RNN states"
    )
    optim.add_argument(
        "--dropout-rnn-output",
        type="bool",
    ...
    optim.add_argument(
        "--optimizer", type=str, default="adamax", help="Optimizer: sgd or adamax"
    )
    optim.add_argument(
        "--learning-rate", type=float, default=0.1, help="Learning rate for SGD only"
    )
    optim.add_argument(
        "--grad-clipping", type=float, default=10, help="Gradient clipping"
    )
    optim.add_argument(
        "--weight-decay", type=float, default=0, help="Weight decay factor"
    )
    ...
    optim.add_argument(
        "--max-len", type=int, default=15, help="The max span allowed during decoding"
    )
